// taken from https://github.com/golang/go/blob/50bd1c4d4eb4fac8ddeb5f063c099daccfb71b26/src/cmd/go/internal/web/http.go
...
func GetMaybeInsecure(importPath string) (urlStr string, body io.ReadCloser, err error) {
